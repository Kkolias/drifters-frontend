      ...
      <ul class="heat-list">
        <li class="heat" @click="showHeat(getHeatForNumber(1))">
          ...
          <div class="heat-wrapper final">
            <div
              class="lead driver"
              :class="{ winner: isWinnerOfHeat(getHeatForNumber(1), 'driver1') }"
            >
              <p>
            ...
            <div
              class="chase driver"
              :class="{ winner: isWinnerOfHeat(getHeatForNumber(1), 'driver2') }"
            >
              <p>
        ...
        <li class="heat" @click="showHeat(getHeatForNumber(2))">
          ...
          <div class="heat-wrapper bronze">
            <div
              class="lead driver"
              :class="{ winner: isWinnerOfHeat(getHeatForNumber(2), 'driver1') }"
            >
              <p>
            ...
            <div
              class="chase driver"
              :class="{ winner: isWinnerOfHeat(getHeatForNumber(2), 'driver2') }"
            >
              <p>
