      ...
      <ul class="heat-list">
        <li class="heat" @click="setSelectedHeat(getHeatForNumber(1))">
          ...
          <div class="heat-wrapper bronze">
            ...
            <div class="chase driver" :class="{ winner: isWinnerOfHeat(getHeatForNumber(1), 'driver2')}">
              <p>
        ...
        <li class="heat" @click="setSelectedHeat(getHeatForNumber(2))">
          <h3>Top 2 vs Top 3</h3>
          <div class="heat-wrapper bronze">
            <div class="lead driver" :class="{ winner: isWinnerOfHeat(getHeatForNumber(2), 'driver1')}">
              <p>
